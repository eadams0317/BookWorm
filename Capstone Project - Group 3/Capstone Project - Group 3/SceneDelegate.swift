...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private enum Constants {
        ...
        static let feedNavigationControllerIdentifier = "TabBarController"
        ...
        User.logout { [weak self] result in
            ...
            case .success:
                ...
                DispatchQueue.main.async {
                    ...
                    let viewController = storyboard.instantiateViewController(withIdentifier: Constants.viewControllerIdentifier)
